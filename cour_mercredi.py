...
fond_option=PhotoImage(file="fond_option3.png")
fond_information=PhotoImage(file="fond_inforamtion1.png")
...
def menu() :
    ...
    bou3=Button(Mafenetre,text="Quitter",command=Mafenetre.destroy)
...
def option():
    ...
    bou4.place(x=711,y=675)
    can2.itemconfig(image_fond,image=fond_option) 
    bou5=Button(Mafenetre,text="INFORMATION",command=information)
    bou5.place(x=715,y=540)
    bou5.config(image=f_information,width=735,height=80,bd=0)
...
def game_over():
    ...
    bou10.place(x=711,y=675)
    
def aff_score(can1):
    """affiche le score a chaque round"""
    texte2=can1.create_text(1200,50,text="score : "+str(score),font=("Impact",70),fill="yellow")
    Mafenetre.update()
...
def victoire(can1):
    ...
    texte1=can1.create_text(730,300,text="Victoire",font=("Impact",85),fill="black")    
    Mafenetre.update()
